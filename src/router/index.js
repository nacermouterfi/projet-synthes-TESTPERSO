...
const router = createRouter({
  ...
  routes: [
...

    {
      ...
      name: "OffresStages",
      component: OffresStages,
    },
    {
      path: "/offres-de-stages/offre-de-stage-details",
      name: "OffreStageDetails",
      component: OffreStageDetails,
    },
    {
      path: "/offre-de-stage-mise-a-jour",
      name: "OffreStageMiseAjour",
      component: OffreStageMiseAjour,
    },
    {
      path: "/offre-de-stage-ajout",
      name: "OffreStageAjout",
      component: OffreStageAjout,
    },
    ...
    {
      path: "/demande-de-stage-details/:id",
      name: "DemandeStageDetails",
      component: DemandeStageDetails,
      props: true,
    },
    {
      path: "/demande-de-stage-mise-a-jour",
      name: "DemandeStageMiseAjour",
      component: DemandeStageMiseAjour,
    }, // à effacer? ça ne devrait pas exister - JO
    {
      path: "/demande-de-stage-mise-a-jour/:id",
      name: "DemandeStageMiseAjour",
      component: DemandeStageMiseAjour,
      props: true,
    },
    {
      path: "/demande-de-stage-ajout",
      name: "DemandeStageAjout",
      component: DemandeStageAjout,
    },
    ...
    {
      path: "/candidat-mise-a-jour/:id",
      name: "CandidatMiseAjour",
      component: CandidatMiseAjour,
      props: true,
    },
    {
      path: "/candidat-ajout",
